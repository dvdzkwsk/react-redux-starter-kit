...
const ACTION_HANDLERS = {
  [RECEIVE_RULE] : (state, action) => action.payload.get('conditions', state),
  ...
  [ADD_CONDITION] : (state, action) => state.set(`${action.id}_${Date.now()}`, defaultCondition.set('ruleId', action.id))
}
